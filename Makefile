...
CFLAGS = -I $(LIBFT) -I /Users/mvan-pee/.brew/opt/readline/include -g -ggdb3 -fsanitize=address #-Wall -Werror -Wextra
LDFLAGS = -lft -lreadline -L $(LIBFT) -L /Users/mvan-pee/.brew/opt/readline/lib -g -ggdb3 -fsanitize=address
