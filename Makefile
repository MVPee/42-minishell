...
CFLAGS = -I $(LIBFT) #-ggdb3 -fsanitize=address #-I /Users/$(shell whoami)/.brew/opt/readline/include -g -ggdb3 -fsanitize=address -Wall -Werror -Wextra
LDFLAGS = -lft -lreadline -L $(LIBFT) #-ggdb3 -fsanitize=address #-L /Users/$(shell whoami)/.brew/opt/readline/lib -g -ggdb3 -fsanitize=address
